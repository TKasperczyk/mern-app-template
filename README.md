...
./install.sh
cp ./backend/config/config.sample.json ./backend/config/config.json
#Edit the configuration file (vi ./backend/config/config.json)
./run.sh
```
